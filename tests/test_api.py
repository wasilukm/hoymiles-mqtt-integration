"""Tests for hoymiles-mqtt HA integration api."""
import asyncio

import aiohttp
from custom_components.hoymiles_mqtt_ha_integration.api import (
    HoymilesMqttHaIntegrationApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = HoymilesMqttHaIntegrationApiClient("test", "test", async_get_clientsession(hass))
